    ...
    try:
        ...
        with app.app_context():
            ...
            try:
                ...
                print(f"成功: 数据库中共有 {total_users} 个用户")
            except Exception as e:
                print(f"失败: 查询用户总数失败: {e}")
                return False
            ...
            try:
                ...
                if security_users:
                    ...
                    if multi_security_users:
                        print(f"成功: 找到 {len(multi_security_users)} 个包含保安身份的用户:")
            ...
            try:
                ...
                if existing_user:
                    print(f"成功: 测试账号 {test_username} 已存在，删除测试账号...")
